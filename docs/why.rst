...
We built `LibCST <https://libcst.readthedocs.io>`_ to make parsing and modifying
source code as a Concrete Syntax Tree easy. Rattle rules take advantage of LibCST APIs
...
Design Principles
=================
When designing Rattle, we used the following list of principles.
