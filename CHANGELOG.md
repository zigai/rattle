...
This is the first stable release with the major rework of Rattle. There are many
...
[Upgrade Guide]: https://github.com/zigai/rattle/upgrade.html
...
This is a beta release of a major rework of Rattle. There are many breaking
...
[User Guide]: https://github.com/zigai/rattle/guide.html
...
This is an alpha release of a major rework of Rattle. There are many breaking
API changes since the `0.1.4` release – existing users should wait for a stable
release before upgrading.
...
## 0.1.4 - 2021-07-30
### Updated
- Fix typo [#163](https://github.com/zigai/rattle/pull/163)
- Refactor ipc_main [#175](https://github.com/zigai/rattle/pull/175)
- Refactor search yaml [#172](https://github.com/zigai/rattle/pull/172)
- Bug fix for UseTypesFromTypingRule [#178](https://github.com/zigai/rattle/pull/178)
- Fix sentinel type error [#187](https://github.com/zigai/rattle/pull/187)
- Autofix docstrings [#190](https://github.com/zigai/rattle/pull/190)
- Fix pyre type-check errors [#196](https://github.com/zigai/rattle/pull/196)
- Add JSON Schema for Rattle configs [#188](https://github.com/zigai/rattle/pull/188)
- Adds allow_list_rules setting for configs [#184](https://github.com/zigai/rattle/pull/184)
- Adds allow_list_rules to schema [#197](https://github.com/zigai/rattle/pull/197)
- Fix run_rules bug [#200](https://github.com/zigai/rattle/pull/200)

## 0.1.3 - 2020-12-09

### New Rules
- Add NoRedundantArgumentsSuperRule [#154](https://github.com/zigai/rattle/pull/154)
- Add ExplicitFrozenDataclassRule [#158](https://github.com/zigai/rattle/pull/158)
- Add UseLintFixmeCommentRule [#161](https://github.com/zigai/rattle/pull/161)
- Add UseAssertInRule [#159](https://github.com/zigai/rattle/pull/159)

### Updated
- await async rule does not account for decorators [#150](https://github.com/zigai/rattle/pull/150)
- Allow glob patterns instead of parent dirs for matching configs [#156](https://github.com/zigai/rattle/pull/156)

## 0.1.2 - 2020-10-29

### New Rules
- Add SortedAttributesRule [#149](https://github.com/zigai/rattle/pull/149)

### Added
- New unified `fixit` CLI [#148](https://github.com/zigai/rattle/pull/148)

### Updated
- Add `use_noqa` configuration to control support of the `noqa` Flake8 suppression comment. Defaults to `False` [#151](https://github.com/zigai/rattle/pull/151)

## 0.1.1 - 2020-10-08

### New Rules
- Add UseAssertIsNotNoneRule [#144](https://github.com/zigai/rattle/pull/144)
- Add MissingHeaderRule to check copyright header comments [#142](https://github.com/zigai/rattle/pull/142)
- Add NoStringTypeAnnotationRule [#140](https://github.com/zigai/rattle/pull/140)
- Add NoNamedTupleRule [#136](https://github.com/zigai/rattle/pull/136)
- Add NoAssertTrueForComparisonsRule to catch some incorrect uses of assertTrue() [#135](https://github.com/zigai/rattle/pull/135)
- Add CollapseIsinstanceChecksRule [#116](https://github.com/zigai/rattle/pull/116)
- Add NoUnnecessaryFormatStringRule and UseFstringRule [#101](https://github.com/zigai/rattle/pull/101)
- Add NoRedundantLambdaRule. [#112](https://github.com/zigai/rattle/pull/112)

### Added
- add_new_rule CLI for adding new rule file [#123](https://github.com/zigai/rattle/pull/123), [#131](https://github.com/zigai/rattle/pull/131)

### Updated
- Ensure first lines remain intact with AddMissingHeaderRule [#143](https://github.com/zigai/rattle/pull/143)
- Documentation improvements: [#113](https://github.com/zigai/rattle/pull/113), [#117](https://github.com/zigai/rattle/pull/117),
[#118](https://github.com/zigai/rattle/pull/118), [#120](https://github.com/zigai/rattle/pull/120)
[#133](https://github.com/zigai/rattle/pull/133), [#138](https://github.com/zigai/rattle/pull/138)
- Improve test message [#137](https://github.com/zigai/rattle/pull/137)

## 0.1.0 - 2020-09-02

### Added

 - First public release of Rattle.
